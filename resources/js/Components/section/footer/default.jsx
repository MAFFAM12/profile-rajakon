                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            {websiteSettings?.social_media.map((data, index) => {
                                ...
                                const getIcon = (data) => {
                                    switch (data.toLowerCase()) {
                                        case 'facebook':
                                            return (
                                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className='size-8' viewBox="0 0 48 48">
                                        ...
                                        case 'youtube':
                                            return (
                                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className='size-9' viewBox="0 0 48 48">
                ...
                <div className="border-t border-gray-800 mt-8 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <p className="text-gray-400 text-sm">
                            © 2019 - 2027 {websiteSettings?.company_name || 'PT. Rajakon Teknik'}. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
